...
public class ClientController {
    ...
    private void handleSearchById() {
        ...
        for (Client client : allClients) {
            // Recherche par ID
            if (String.valueOf(client.getIdClient()).contains(searchText)) {
    ...
    private void handleAjouter() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/pidev/AjouterClient.fxml"));
