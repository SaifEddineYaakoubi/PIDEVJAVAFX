package org.example.pidev.controllers.cultures;
...
public class ConsulterCultureController implements Initializable {
    ...
    @FXML private VBox sidebarCulture;
    ...
    public void hideSidebar() {
        if (sidebarCulture != null) {
            sidebarCulture.setVisible(false);
            sidebarCulture.setManaged(false);
        }
    }
    ...
    void modifierCulture(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/cultures/modifierculture.fxml"));
    ...
    @FXML void navigateToConsulterParcelle(ActionEvent event) { navigateTo("/parcelles/consulterparcelle.fxml", "Liste des Parcelles"); }

    @FXML void navigateToDashboard(ActionEvent event) { navigateTo("/recoltes/Dashboard.fxml", "Dashboard"); }

    @FXML
    void navigateToAjouterCulture(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/cultures/ajouterculture.fxml"));
            Parent root = loader.load();
            Stage popupStage = new Stage();
            popupStage.initModality(javafx.stage.Modality.APPLICATION_MODAL);
            popupStage.initOwner(listViewCultures.getScene().getWindow());
