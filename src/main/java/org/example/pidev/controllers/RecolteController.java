...
public class RecolteController {
            ...
            colAction.setCellFactory(col -> new TableCell<Recolte, Void>() {
                ...
                protected void updateItem(Void item, boolean empty) {
                    ...
                    if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                        ...
                        bEdit.getStyleClass().add("button-secondary");
                        bEdit.setOnAction(e -> handleModifier(r));

                        Button bDel = new Button("🗑️ Supprimer");
                        bDel.getStyleClass().add("button-secondary");
    ...
    private void handleDetailRecolte(Recolte recolte) {
        try {
            ...
            stage.setTitle("Détail de la Récolte - ID: " + recolte.getIdRecolte());
    ...
    private void handleChercher() {
        ...
        for (Recolte r : recolteList) {
            if (String.valueOf(r.getIdRecolte()).contains(s) ||
                (r.getTypeCulture() != null && r.getTypeCulture().toLowerCase().contains(s)) ||
    ...
    private void handleSupprimer(Recolte r) {
        ...
        a.setHeaderText("Supprimer une récolte");
        a.setContentText("Êtes-vous sûr de vouloir supprimer la récolte ID: " + r.getIdRecolte() + "?");
        a.showAndWait().ifPresent(bt -> {
            if (bt == ButtonType.OK) {
                recolteService.delete(r.getIdRecolte());
